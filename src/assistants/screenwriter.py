...
system_role_content = {
    'English': (
                ...
                + "Melfi does not describe people's feelings, she only focuses on reactions such as laughter, mimical expressions and etc.\n"
    ...
    'Polski': (
                ...
                + "Melfi nie opisuje uczuć ludzi, a tylko skupia się na reakcjach, takich jak śmiech, wyrażenia mimiczne itp.\n"
                ...
                + "Melfi potrzebuje umieć tworzyć scenariusze w języku, którym klient chce się posługiwać.\n"
